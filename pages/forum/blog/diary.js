        ...
        <Row className={Style.antRow}>
          ...
          <Col span={16}>
            ...
            <div className={Style.postNav}>
              <div className={Style.petImg}><img className={Style.profile} src={'/forum_img/profile.png'}/></div>
              <div className={Style.postNavText}>
                <p className={Style.haru}>哈嚕 <img className={Style.shiba} src='/forum_img/shiba.png'/></p>
            ...
            <div className={Style.diaryBody}>
                  ...
                  <div className={Style.imgBorder}>
                      ...
                      <div className={Style.imgHidden}>
                          <div className={Style.imgRange} style={{ left: move === 1 ? '-200px' : '0',  transition: 'left 0.3s ease-in-out'}}>
                            <img className={Style.img} src={'/forum_img/毛1.png'}/>
                            <img className={Style.img} src={'/forum_img/毛1-2.jpg'}/>
                          </div>
                      </div>
                      <div className={Style.right}>
                          <FontAwesomeIcon icon={faChevronRight} onClick={right1}/>
                      </div>
                  </div>
              ...
              <div className={Style.card}>
                  ...
                  <div className={Style.imgBorder}>
                      ...
                      <div className={Style.imgHidden}>
                          <div className={Style.imgRange} style={{ left: two === 1 ? '-200px' : '0',  transition: 'left 0.3s ease-in-out'}}>
                          <img className={Style.img} src={'/forum_img/毛2-1.png'}/>
                          <img className={Style.img} src={'/forum_img/毛2-2.png'}/>
                          </div>
                      </div>
                      <div className={Style.right}>
                          <FontAwesomeIcon icon={faChevronRight} onClick={right2}/>
                      </div>
                  </div>
            ...
            <div className={Style.imgBorder}>
                ...
                <div className={Style.imgHidden}>
                    <div className={Style.imgRange} style={{ left: five === 1 ? '-200px' : '0',  transition: 'left 0.3s ease-in-out'}}>
                    <img className={Style.img} src={'/forum_img/毛5-1.png'}/>
                    <img className={Style.img} src={'/forum_img/毛5-2.png'}/> 
                    </div>
                </div>
                <div className={Style.right}>
                    <FontAwesomeIcon icon={faChevronRight} onClick={right5}/>
                </div>
            </div>
            <div className={Style.diaryDate}>2022.10.22</div>
            <div className={Style.diaryTitle}>{'陪主人踏青汪'}</div>
            <div className={Style.diaryContent}>{'我是不是很上相呀汪😎'}</div>      
            </div>
            ...
            <div className={Style.imgBorder}>
                ...
                <div className={Style.imgHidden}>
                    <div className={Style.imgRange} style={{ left: six === 1 ? '-200px' : '0',  transition: 'left 0.3s ease-in-out'}}>
                    <img className={Style.img} src={'/forum_img/毛6-1.png'}/>
                    <img className={Style.img} src={'/forum_img/毛6-2.png'}/> 
                    </div>
                </div>
                <div className={Style.right}>
                    <FontAwesomeIcon icon={faChevronRight} onClick={right6}/>
                </div>
            </div>
            <div className={Style.diaryDate}>2023.03.01</div>
            <div className={Style.diaryTitle}>{'櫻花開了汪'}</div>
            <div className={Style.diaryContent}>{'家附近公園櫻花開了汪～來當網美狗狗了汪🦊'}</div>      
            </div>
