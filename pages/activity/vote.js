...
export default function ActivityVote() {
  // 網址在這看 http://localhost:3000/wish
  ...
  return (
    <div>
      ...
      <div className={styles.type}>
        <div className="container-inner">
          <div className={styles.type_btn_group}>
            ...
            <Link
              href={`${process.env.WEB}/vote`}
              className={styles.custom_link}
            >
              <SubBtn img="../activity_img/subicon_7.png" text="我要投票" />
            </Link>
            <Link
              href={`${process.env.WEB}/wish`}
              className={styles.custom_link}
            >
              <SubBtn img="../activity_img/subicon_8.png" text="我要許願" />
            </Link>
      ...
      <div className="container-inner">
        <div>
          <p className={styles.title}>發起活動 呼聲最高TOP3</p>
