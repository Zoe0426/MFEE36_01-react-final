  ...
  return (
    <div className="container-inner">
      ...
      <div className={styles.nav_detail} >
        <NavDetailPage text1="活動內容" text2="活動行程" text3="活動規範" text4="購買須知&取消政策" text5="顧客評價" text6="為您推薦" />
      </div>
      ...
      <div className={styles.content}>
        <div>
          ...
          <p>今夏最大「毛小孩都市水樂園」活動即將在圓山花博公園盛大登場！覺得海太遠？幫你搬過來不用跑到墾丁衝到離島，就在台北圓山捷運站1號出口。歡迎帶 毛小孩 來參加 圓山花博廣場 的 台北海洋水樂園 現場免費開放寵物游泳池 、玩SUP、寵物義剪服務，盡情享受美好午後時光。請自備毛巾，捷運圓山站1號出口世界海洋日台北海洋水樂園、寵物義剪、寵物水上活動、寵物水中跑步、寵物趣味闖關遊戲、寵物自助洗吹體驗現場還有寵物市集～前所未有的都市海洋驚艷 ，歡迎大家一起來共襄盛舉。</p>
          <br />
          <br />
          <p>行程行程行程--行程行程行程--行程行程行程--程行程行程--行程行程行程--行程行程行程--行程行程行程</p>
        </div>
          
        <img className={styles.content_image} src='/activity_img/act1_1.jpg' alt='' />
      </div>
      ...
      <div className={styles.content}>
        ...
        <div>
          ...
          <p>寵物於園區內活動時，須全程置於提袋、提籠、推車等限制活動範圍的器具內，或是妥善繫上最長1.5公尺的繫繩，並禁止與野生動物接觸。非指定區域，寵物不得進入。寵物如產生不聽指令、攻擊行為，飼主應立即將寵物帶離園區。園區內發生的衝突情事，若涉及訴訟或賠償問題，由飼主負責。寵物食品禁止遺留園區。寵物若產生糞便，飼主應隨手清理並丟置垃圾桶。飼主應善盡維護園區清潔和安全秩序的責任。上述規範飼主經勸導若仍拒絕遵守，管理單位得要求飼主立即攜帶寵物離開園區，且不得要求退費或賠償。</p>
        </div>
      </div>
