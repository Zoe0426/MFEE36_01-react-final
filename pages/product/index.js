  ...
  const eightCatergoriesData = [
    {
      ...
      text: '飼料',
      icon: food,
      href: 'http://localhost:3000/product/food',
    },
    {
      id: 'can',
      text: '罐頭',
      icon: can,
      href: 'http://localhost:3000/product/can',
    },
    {
      id: 'snack',
      text: '零食',
      icon: snack,
      href: 'http://localhost:3000/product/snack',
    },
    {
      id: 'health',
      text: '保健品',
      icon: health,
      href: 'http://localhost:3000/product/health',
    },
    {
      id: 'toy',
      text: '玩具',
      icon: toy,
      href: 'http://localhost:3000/product/toy',
    },
    {
      id: 'dress',
      text: '服飾',
      icon: dress,
      href: 'http://localhost:3000/product/dress',
    },
    {
      id: 'outdoor',
      text: '戶外用品',
      icon: outdoor,
      href: 'http://localhost:3000/product/outdoor',
    },
    {
      id: 'other',
      text: '其他',
